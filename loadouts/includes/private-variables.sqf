private [
    ...
    "_defaultSide","_commonRIFLE","_commonRIFLEGL","_commonPISTOL","_commonAR", "_factionName",
    "_factionSide", "_factionID", "_factionCallsigns", "_factionUnits", "_factionVehicles", "_factionSkill", "_defaultFace", "_defaultVoice",
    ...
    "_countMG", "_countAR", "_countSNIPER", "_countAT", "_countGRENADES", "_count40mm", "_countRifleCARGO",
    ...
    "_countMgCARGO", "_countArCARGO", "_countSniperCARGO", "_countATCARGO", "_countGrenadesCARGO", "_count40mmCARGO",
    ...
    "_spareBarrel", "_kestrel", "_rangeCard", "_spottingScope", "_flashlight", "_IRStrobe", "_clacker", "_M26clacker", "_defusalKit","_defib",
