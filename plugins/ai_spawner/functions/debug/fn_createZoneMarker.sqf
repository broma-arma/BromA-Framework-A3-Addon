...
private _marker = createMarker [(format ["BRM_FMK_AIS_mrk_%1_%2",_id,_zone]), getPos _zone];
...
_markerText = [_id,_zone,"mil_dot",([_side,true] call BRM_FMK_AIS_fnc_getSideColor),""] call BRM_FMK_AIS_fnc_createIconMarker;
