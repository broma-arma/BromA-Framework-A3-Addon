...
// ["LOCAL", "CHAT", format["COUNT A: %5 deaths out of %1 | %2 PCENT / COUNT B: %6 deaths out of %3 | %4 PCENT", _countplayersA, _percentA, _countplayersB, _percentB, mission_dead_side_A, mission_dead_side_B]] call BRM_FMK_fnc_doLog;
