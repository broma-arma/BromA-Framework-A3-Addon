...
switch (side player) do {
    case WEST : {
        ...
        call compile preprocessFileLineNumbers "mission\briefings\briefing-west.sqf";
    };
    case EAST : {
        if (_autoRadio) then {
        ...
        call compile preprocessFileLineNumbers "mission\briefings\briefing-east.sqf";
    };
    case RESISTANCE : {
        if (_autoRadio) then {
        ...
        call compile preprocessFileLineNumbers "mission\briefings\briefing-ind.sqf";
    };
    case CIVILIAN : {
        if (_autoRadio) then {
        ...
        call compile preprocessFileLineNumbers "mission\briefings\briefing-civ.sqf";
    };
};
