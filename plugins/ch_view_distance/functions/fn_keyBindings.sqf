...
_decViewdistKey = ["CH View Distance", "dec_viewdistance", _textDecreaseVD, {[0] call BRM_FMK_Plugin_CHVD_fnc_keyDown}, "", [DIK_LBRACKET, [false, true, false]], true] call CBA_fnc_addKeybind;

_textIncreaseVD = if (isLocalized "STR_chvd_increaseVD") then {localize "STR_chvd_increaseVD"} else {"Increase view distance"};
_incViewdistKey = ["CH View Distance", "inc_viewdistance", _textIncreaseVD, {[1] call BRM_FMK_Plugin_CHVD_fnc_keyDown}, "", [DIK_RBRACKET, [false, true, false]], true] call CBA_fnc_addKeybind;
...
_openSettingsKey = ["CH View Distance", "open_settings", _textOpenSettings, {call BRM_FMK_Plugin_CHVD_fnc_openDialog}, "", [DIK_BACKSLASH, [false, true, false]], false] call CBA_fnc_addKeybind;
...
_decTerrainKey = ["CH View Distance", "dec_terrain_quality", _textDecreaseTerrain, {[-1] call BRM_FMK_Plugin_CHVD_fnc_keyDownTerrain}, "", [DIK_LBRACKET, [true, false, false]], true] call CBA_fnc_addKeybind;
...
_incTerrainKey = ["CH View Distance", "inc_terrain_quality", _textIncreaseTerrain, {[1] call BRM_FMK_Plugin_CHVD_fnc_keyDownTerrain}, "", [DIK_RBRACKET, [true, false, false]], true] call CBA_fnc_addKeybind;
