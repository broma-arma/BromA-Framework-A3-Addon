...
// INFO ========================================================================
/*
    Finnish Defense Force :-DD BENIS
*/
...
_commonRIFLE = ["hlc_rifle_RK62","hlc_30Rnd_762x39_b_ak"];
_commonRIFLEGL = ["hlc_rifle_RK62","hlc_30Rnd_762x39_b_ak"];
_commonPISTOL = ["hlc_pistol_P226WestGerman","rhsusf_mag_17Rnd_9x19_JHP"];
_commonMG = ["rhs_weap_m84","rhs_100Rnd_762x54mmR"];
_commonAR = ["rhs_weap_m84","rhs_100Rnd_762x54mmR"];
_commonMARKSMAN = ["rhs_weap_svdp_wd_npz","rhs_10Rnd_762x54mmR_7N1"];
_commonSNIPER = ["rhs_weap_svdp_wd_npz","rhs_10Rnd_762x54mmR_7N1"];
