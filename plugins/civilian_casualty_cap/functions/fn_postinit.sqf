...
if (isClass (configFile >> "CfgPatches" >> "ace_medical")) then {
	...
	["Civilian", "init", BRM_FMK_CivilianCasualtyCap_fnc_civInit, true, [], true] call CBA_fnc_addClassEventHandler;
} else {
	addMissionEventHandler ["EntityKilled", BRM_FMK_CivilianCasualtyCap_fnc_civKilled];
};
