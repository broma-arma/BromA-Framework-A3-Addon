...
_statement = ""null=['%1',[%2,%3,%4], %5, %6, %7, %8, [%9, %9, %10,0]] call BRM_FMK_DAC_fnc_DACZone"";
%1 setTriggerStatements ['(true)', _statement, ''];", _name, _id, _status, _faction, _arg1, _arg2, _arg3, _arg4, _side, _skill, _ax, _ay, _aa, _as, _pos];
