...
Returns:
	Settings, nil if setting doesn't exist [ARRAY/NIL]
		...
		_behaviour - Switches the unit behaviour when the waypoint becomes active: "UNCHANGED", "CARELESS", "SAFE", "AWARE", "COMBAT", "STEALTH" [STRING]
		_forceBehaviour - Force the behavior of a waypoint, disables AUTOCOMBAT. [BOOLEAN]
