...
if (_loadoutCondition) then {
    ...
    call compile preprocessFile "mission\loadouts\faction-list.sqf";
};
// =============================================================================
...
if (_factionID in modified_loadouts) then {
    call compile preprocessFile "mission\loadouts\mod-list.sqf";
};
// =============================================================================
...
if (_assignLoadoutMode) then {
    ...
    if (_factionStructure in read_local_structure_specific) then {
        call compile preprocessFile "mission\loadouts\structure-list.sqf";
    } else {
