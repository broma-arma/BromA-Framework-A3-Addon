...
if !(mission_game_mode == "coop") then {
    ...
    zone1 = [_resp1, setup_zone_area, mission_setup_time, side_a_side] spawn BRM_FMK_SetupZone_fnc_setupZone;
    zone2 = [_resp2, setup_zone_area, mission_setup_time, side_b_side] spawn BRM_FMK_SetupZone_fnc_setupZone;

    if (mission_enable_side_c) then {
    zone3 = [_resp3, setup_zone_area, mission_setup_time, side_c_side] spawn BRM_FMK_SetupZone_fnc_setupZone;
    };
};
