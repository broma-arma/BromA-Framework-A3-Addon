// INFO ========================================================================
/*
    German army using tropentarn camouflage
*/

_factionID        = "GERMANDES";
...
_headsLIST = [
    "BRM_OPSCORE_TROPEN_NSW",
    "rhsusf_opscore_fg_pelt_nsw",
    "rhsusf_opscore_fg_pelt_cam",
    "BRM_OPSCORE_TROPEN_NSWCAM"
];
...
_vestsLIST = [
    ...
    "BRM_RHS_SPCS_TROPEN_squadleader",
    "BRM_RHS_SPCS_TROPEN_rifle"
];
...
_commonVEST = "BRM_IOTV_TROPEN_RFL";
_officerVEST = "BRM_IOTV_TROPEN_REPAIR";
_ftlVEST = "BRM_IOTV_TROPEN_TL";
_slVEST = "BRM_IOTV_TROPEN_SL";
_mgVEST = "BRM_IOTV_TROPEN_SAW";
_grenadierVEST = "BRM_IOTV_TROPEN_GL";
_medicVEST = "BRM_IOTV_TROPEN_MED";
_demoVEST = _commonVEST;
_marksmanVEST = _commonVEST;
_reconVEST = _randomVEST;

_commonBACKPACK = "BRM_eagleiii_TROPEN";
