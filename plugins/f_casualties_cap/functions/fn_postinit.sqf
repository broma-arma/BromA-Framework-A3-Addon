...
if (mission_game_mode == "tvt") then {    
    ...
    [_casA, mission_cas_cap, endings_tvt_auto] spawn BRM_FMK_f_cas_cap_fnc_CasualtiesCapCheck;
        
    [_casB, mission_cas_cap, endings_tvt_auto] spawn BRM_FMK_f_cas_cap_fnc_CasualtiesCapCheck;

    if (mission_enable_side_c) then {        
        [_casC, mission_cas_cap, endings_tvt_auto] spawn BRM_FMK_f_cas_cap_fnc_CasualtiesCapCheck;
    };
} else {
    [_casA, mission_cas_cap, endings_defeat] spawn BRM_FMK_f_cas_cap_fnc_CasualtiesCapCheck;
};
