    ...
    [{!(isNil "BRM_FMK_MapCover_VAR_coverCreated")}, {
        ...
        private _BRM_FMK_MapCover_fnc_renderMap = {
            for "_i" from 0 to 270 step 90 do {
                ...
                _coverMap setMarkerBrush BRM_FMK_MapCover_VAR_mapBrush;
                _coverMap setMarkerAlpha BRM_FMK_MapCover_VAR_mapOpacity;
                _coverMap setMarkerColor BRM_FMK_MapCover_VAR_mapColor;
            };
        };
