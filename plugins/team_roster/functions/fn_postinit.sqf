...
_orbatText = "<br/><br/>============= Team Roster =============<br/>";
{
    ...
    if (_checkin) then {
        _orbatText = _orbatText + format["<br/>--------- %1 Team ---------<br/>",(groupID _x)];
        {
            ...
            _color = [_color] call BRM_FMK_fnc_colorToHex;
            ...
            if (_IsMedic == 1) then { _sign = " (<img image='\broma_framework\plugins\team_roster\assets\med_icon.paa' width='16' heigth='16' />)" } else { _sign = "" };
